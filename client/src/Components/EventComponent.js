...
class Events extends Component {
  ...
  componentDidMount() {
    ...
    /*document
      .getElementById('technical_down_arrow')
      .addEventListener('click', () => {
        if (
          document.getElementById('technical_events_envelope').style.height ==
            300 + 'px' ||
          document.getElementById('technical_events_envelope').style.height ==
            500 + 'px'
        ) {
    ...
    /*document
      .getElementById('nontechnical_down_arrow')
      .addEventListener('click', () => {
        if (
          document.getElementById('non-technical_events_envelope').style
            .height ==
            500 + 'px' ||
          document.getElementById('technical_events_envelope').style.height ==
            500 + 'px'
      ...
      return (
        <>
          ...
          <div id='non-technical_events_envelope'>
            <h3
              class='non-technical_event_title'
              style={{ color: 'black', paddingTop: '5%' }}
            >
              Non-Technical Events{' '}
            </h3>
            <div class='row'>{nonTech}</div>
          </div>
          {/* 
