    ...
    <div class='event_element '>
          ...
          <div class='flip-card'>
            <div class='flip-card-inner'>
              ...
              <div class='flip-card-back'>
                ...
                <p class='card-text'>
                  The official freshers for all the first year CSE students!
                </p>
                Date: Not Declared
                <br />
                <a href='#' class='btn btn-success'>
                  View the previous freshers!
                </a>
              </div>
            </div>
          </div>
          ...
          <div class='flip-card'>
            <div class='flip-card-inner'>
              ...
              <div class='flip-card-back'>
                ...
                <p class='card-text'>
                  Consists of various workshops, webinars to introduce new
                  concepts to students
                </p>
                <div class='card-action'>Date: Not Declared</div>
                <br />
                <a href='#' class='btn btn-success'>
                  More info
                </a>
      ...
      <div class='alert mt-5' role='alert'>
        <h3 style={{ textAlign: 'center' }}>
          {' '}
          We have more events planned out! For more info check out our events
          page{' '}
        </h3>
      </div>
    </div>
